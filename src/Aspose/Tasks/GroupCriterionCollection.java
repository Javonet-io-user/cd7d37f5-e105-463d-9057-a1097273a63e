...
public class GroupCriterionCollection
    implements jio.System.Collections.Generic.ICollection<GroupCriterion>,
        jio.System.Collections.Generic.IEnumerable<GroupCriterion>,
  ...
  public Iterator<GroupCriterion> iterator() {
    return (Iterator<GroupCriterion>) this.GetEnumerator();
  }
  /** GetProperty */
  ...
  public GroupCriterionCollection(NObject handle) {
  ...
  public jio.System.Collections.Generic.IEnumerator<GroupCriterion> GetEnumerator() {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Contains(GroupCriterion item) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public void CopyTo(GroupCriterion[] array, java.lang.Integer arrayIndex) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Remove(GroupCriterion item) {
    try {
  ...
  public List<GroupCriterion> ToList() {
    try {
      ...
      if (res == null) return null;
      return new List<GroupCriterion>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
