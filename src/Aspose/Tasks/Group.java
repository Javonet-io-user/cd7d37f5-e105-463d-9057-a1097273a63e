...
public class Group {
  ...
  public void setShowSummary(java.lang.Boolean value) {
    try {
      javonetHandle.set("ShowSummary", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.Boolean getShowSummary() {
    try {
      java.lang.Boolean res = javonetHandle.get("ShowSummary");
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setMaintainHierarchy(java.lang.Boolean value) {
    try {
      javonetHandle.set("MaintainHierarchy", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.Boolean getMaintainHierarchy() {
    try {
      java.lang.Boolean res = javonetHandle.get("MaintainHierarchy");
      if (res == null) return false;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void setGroupCriteria(GroupCriterionCollection value) {
    try {
      javonetHandle.set("GroupCriteria", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public GroupCriterionCollection getGroupCriteria() {
    try {
      Object res = javonetHandle.<NObject>get("GroupCriteria");
      if (res == null) return null;
      return new GroupCriterionCollection((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public Group() {
    try {
      javonetHandle = Javonet.New("Aspose.Tasks.Group");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public Group(NObject handle) {
