...
public class WorkWeekCollection
    implements jio.System.Collections.Generic.IEnumerable<WorkWeek>,
  ...
  public Iterator<WorkWeek> iterator() {
    return (Iterator<WorkWeek>) this.GetEnumerator();
  }
  /** GetProperty */
  ...
  public WorkWeekCollection(NObject handle) {
  ...
  public void Add(WorkWeek workWeek) {
    try {
      javonetHandle.invoke("Add", workWeek);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public List<WorkWeek> ToList() {
    try {
      ...
      if (res == null) return null;
      return new List<WorkWeek>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  @MethodTypeAnnotation(type = "Method")
  public jio.System.Collections.Generic.IEnumerator<WorkWeek> GetEnumerator() {
    try {
