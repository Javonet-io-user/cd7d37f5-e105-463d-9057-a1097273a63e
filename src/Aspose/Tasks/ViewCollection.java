...
public class ViewCollection
    implements jio.System.Collections.Generic.ICollection<View>,
        jio.System.Collections.Generic.IEnumerable<View>,
  ...
  public Iterator<View> iterator() {
    return (Iterator<View>) this.GetEnumerator();
  }
  /** GetProperty */
  ...
  public ViewCollection(NObject handle) {
  ...
  public jio.System.Collections.Generic.IEnumerator<View> GetEnumerator() {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Contains(View item) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public void CopyTo(View[] array, java.lang.Integer arrayIndex) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Remove(View item) {
    try {
  ...
  public List<View> ToList() {
    try {
      ...
      if (res == null) return null;
      return new List<View>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
