...
public class RiskAnalysisResult {
  ...
  public RiskAnalysisResult(NObject handle) {
  ...
  public RiskItemStatisticsCollection GetRiskItems(RiskItemType itemType) {
    try {
      Object res = javonetHandle.invoke("GetRiskItems", NEnum.fromJavaEnum(itemType));
      if (res == null) return null;
      return new RiskItemStatisticsCollection((NObject) res);
