...
public class TaskBaselineCollection
    implements jio.System.Collections.Generic.IEnumerable<TaskBaseline>,
  ...
  public Iterator<TaskBaseline> iterator() {
    return (Iterator<TaskBaseline>) this.GetEnumerator();
  }
  /** GetProperty */
  ...
  public TaskBaselineCollection(NObject handle) {
  ...
  public jio.System.Collections.Generic.IEnumerator<TaskBaseline> GetEnumerator() {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Remove(TaskBaseline baseline) {
    try {
  ...
  public List<TaskBaseline> ToList() {
    try {
      ...
      if (res == null) return null;
      return new List<TaskBaseline>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
