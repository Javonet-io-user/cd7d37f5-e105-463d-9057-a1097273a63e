...
public class WeekDayCollection
    implements jio.System.Collections.Generic.IEnumerable<WeekDay>,
  ...
  public Iterator<WeekDay> iterator() {
    return (Iterator<WeekDay>) this.GetEnumerator();
  }
  /** GetProperty */
  ...
  public WeekDayCollection(NObject handle) {
  ...
  public jio.System.Collections.Generic.IEnumerator<WeekDay> GetEnumerator() {
    try {
  ...
  public void Add(WeekDay weekDay) {
    try {
      javonetHandle.invoke("Add", weekDay);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public List<WeekDay> ToList() {
    try {
      ...
      if (res == null) return null;
      return new List<WeekDay>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
