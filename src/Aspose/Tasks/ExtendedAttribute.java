...
public class ExtendedAttribute {
  ...
  public void setAttributeDefinition(ExtendedAttributeDefinition value) {
    try {
      javonetHandle.set("AttributeDefinition", value);
  ...
  public ExtendedAttributeDefinition getAttributeDefinition() {
    try {
      Object res = javonetHandle.<NObject>get("AttributeDefinition");
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setValueGuid(java.lang.String value) {
    try {
      javonetHandle.set("ValueGuid", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.String getValueGuid() {
    try {
      java.lang.String res = javonetHandle.get("ValueGuid");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.Boolean getValueReadOnly() {
    try {
      java.lang.Boolean res = javonetHandle.get("ValueReadOnly");
  ...
  public ExtendedAttribute() {
    try {
      javonetHandle = Javonet.New("Aspose.Tasks.ExtendedAttribute");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public ExtendedAttribute(NObject handle) {
