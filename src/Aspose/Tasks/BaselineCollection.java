...
public class BaselineCollection
    implements jio.System.Collections.Generic.IEnumerable<Baseline>,
        jio.System.Collections.IEnumerable,
        Iterable<Baseline> {
  protected NObject javonetHandle;

  @Override
  public Iterator<Baseline> iterator() {
    return (Iterator<Baseline>) this.GetEnumerator();
  }
  /** GetProperty */
  ...
  public BaselineCollection(NObject handle) {
  ...
  public jio.System.Collections.Generic.IEnumerator<Baseline> GetEnumerator() {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Remove(Baseline baseline) {
    try {
  ...
  public List<Baseline> ToList() {
    try {
      ...
      if (res == null) return null;
      return new List<Baseline>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
