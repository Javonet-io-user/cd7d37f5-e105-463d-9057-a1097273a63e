...
public class WBSCodeMaskCollection
    implements jio.System.Collections.Generic.ICollection<WBSCodeMask>,
        jio.System.Collections.Generic.IEnumerable<WBSCodeMask>,
  ...
  public Iterator<WBSCodeMask> iterator() {
    return (Iterator<WBSCodeMask>) this.GetEnumerator();
  }
  /** GetProperty */
  ...
  public WBSCodeMaskCollection(NObject handle) {
  ...
  public jio.System.Collections.Generic.IEnumerator<WBSCodeMask> GetEnumerator() {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Contains(WBSCodeMask item) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public void CopyTo(WBSCodeMask[] array, java.lang.Integer arrayIndex) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Remove(WBSCodeMask item) {
    try {
  ...
  public List<WBSCodeMask> ToList() {
    try {
      ...
      if (res == null) return null;
      return new List<WBSCodeMask>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
