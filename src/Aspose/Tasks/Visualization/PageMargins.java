...
public class PageMargins {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setBorders(Border value) {
    try {
      javonetHandle.set("Borders", NEnum.fromJavaEnum(value));
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public Border getBorders() {
    try {
      Object res = javonetHandle.<NEnum>get("Borders");
      if (res == null) return null;
      return Border.valueOf(((NEnum) res).getValueName());
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public PageMargins() {
    try {
      javonetHandle = Javonet.New("Aspose.Tasks.Visualization.PageMargins");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public PageMargins(NObject handle) {
