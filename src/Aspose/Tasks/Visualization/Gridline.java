...
public class Gridline {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setGridlineType(GridlineType value) {
    try {
      javonetHandle.set("GridlineType", NEnum.fromJavaEnum(value));
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public GridlineType getGridlineType() {
    try {
      Object res = javonetHandle.<NEnum>get("GridlineType");
      if (res == null) return null;
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setPattern(LinePattern value) {
    try {
  ...
  public Gridline() {
    try {
      javonetHandle = Javonet.New("Aspose.Tasks.Visualization.Gridline");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public Gridline(NObject handle) {
