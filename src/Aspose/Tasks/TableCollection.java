...
public class TableCollection
    implements jio.System.Collections.Generic.ICollection<Table>,
        jio.System.Collections.Generic.IEnumerable<Table>,
  ...
  public Iterator<Table> iterator() {
    return (Iterator<Table>) this.GetEnumerator();
  }
  /** GetProperty */
  ...
  public TableCollection(NObject handle) {
  ...
  public jio.System.Collections.Generic.IEnumerator<Table> GetEnumerator() {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Contains(Table item) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public void CopyTo(Table[] array, java.lang.Integer arrayIndex) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Remove(Table item) {
    try {
  ...
  public List<Table> ToList() {
    try {
      ...
      if (res == null) return null;
      return new List<Table>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
