...
public class RateCollection
    implements jio.System.Collections.Generic.IEnumerable<Rate>,
  ...
  public Iterator<Rate> iterator() {
    return (Iterator<Rate>) this.GetEnumerator();
  }
  /** GetProperty */
  ...
  public RateCollection(NObject handle) {
  ...
  public jio.System.Collections.Generic.IEnumerator<Rate> GetEnumerator() {
    try {
  ...
  public Rate Add(DateTime ratesFrom) {
    try {
      Object res = javonetHandle.invoke("Add", ratesFrom);
      if (res == null) return null;
      return new Rate((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Remove(Rate item) {
    try {
  ...
  public List<Rate> ToList() {
    try {
      ...
      if (res == null) return null;
      return new List<Rate>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
