...
public class FilterCollection
    implements jio.System.Collections.Generic.ICollection<Filter>,
        jio.System.Collections.Generic.IEnumerable<Filter>,
  ...
  public Iterator<Filter> iterator() {
    return (Iterator<Filter>) this.GetEnumerator();
  }
  /** GetProperty */
  ...
  public FilterCollection(NObject handle) {
  ...
  public jio.System.Collections.Generic.IEnumerator<Filter> GetEnumerator() {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Contains(Filter item) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public void CopyTo(Filter[] array, java.lang.Integer arrayIndex) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Remove(Filter item) {
    try {
  ...
  public List<Filter> ToList() {
    try {
      ...
      if (res == null) return null;
      return new List<Filter>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
