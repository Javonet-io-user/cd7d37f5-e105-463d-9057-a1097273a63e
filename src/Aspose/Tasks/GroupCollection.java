...
public class GroupCollection
    implements jio.System.Collections.Generic.ICollection<Group>,
        jio.System.Collections.Generic.IEnumerable<Group>,
  ...
  public Iterator<Group> iterator() {
    return (Iterator<Group>) this.GetEnumerator();
  }
  /** GetProperty */
  ...
  public GroupCollection(NObject handle) {
  ...
  public jio.System.Collections.Generic.IEnumerator<Group> GetEnumerator() {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Contains(Group item) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public void CopyTo(Group[] array, java.lang.Integer arrayIndex) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Remove(Group item) {
    try {
  ...
  public List<Group> ToList() {
    try {
      ...
      if (res == null) return null;
      return new List<Group>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
