...
public class ParseErrorArgs {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public jio.System.Type getFieldType() {
    try {
      Object res = javonetHandle.<NObject>get("FieldType");
      if (res == null) return null;
  ...
  public java.lang.String getInvalidValue() {
    try {
      java.lang.String res = javonetHandle.get("InvalidValue");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public ParseErrorArgs(NObject handle) {
