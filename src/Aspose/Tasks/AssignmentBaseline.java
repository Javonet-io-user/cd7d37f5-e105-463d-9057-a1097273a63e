...
public class AssignmentBaseline extends Baseline
    implements IComparableT<Baseline>, IEquatable<AssignmentBaseline> {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setStart(Nullable<DateTime> value) {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public Nullable<DateTime> getStart() {
    try {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setFinish(Nullable<DateTime> value) {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public Nullable<DateTime> getFinish() {
    try {
  ...
  public AssignmentBaseline(NObject handle) {
    super(handle);
  ...
  public java.lang.Boolean Equals(AssignmentBaseline other) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Integer CompareTo(AssignmentBaseline other) {
    try {
